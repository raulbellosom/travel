...
import ThemeToggle from "../components/common/organisms/Navbar/ThemeToggle";
import LanguageSwitcher from "../components/common/organisms/Navbar/LanguageSwitcher";
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-6 lg:grid-cols-2">
          <section className="relative hidden overflow-hidden rounded-3xl border border-slate-200 bg-slate-900 shadow-xl lg:block dark:border-slate-700">
            <img
              ...
              loading="lazy"
            />
            <div className="absolute inset-0 bg-linear-to-br from-slate-950/75 via-slate-900/45 to-cyan-700/45" />
