...
export default function LocationStepForm({
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col items-start gap-3 rounded-2xl border border-cyan-200 bg-cyan-50/60 px-4 py-4 dark:border-cyan-500/20 dark:bg-cyan-950/20 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <p className="text-sm font-medium text-cyan-800 dark:text-cyan-200">
            {t("mapPicker.title")}
          </p>
          <p className="mt-0.5 text-xs text-cyan-700/80 dark:text-cyan-300/70">
