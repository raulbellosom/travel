...
const HINTS_BY_COMMERCIAL_MODE = Object.freeze({
  rent_long_term: {
    key: "propertyForm.wizard.commercialConditionsHint.longTerm",
    defaultValue:
      "Define condiciones de contrato para renta de mediano o largo plazo.",
  },
  rent_short_term: {
    key: "propertyForm.wizard.commercialConditionsHint.shortTerm",
    defaultValue:
      "Configura reglas de estancia y operacion para reservas por fecha.",
  },
  rent_hourly: {
    key: "propertyForm.wizard.commercialConditionsHint.hourly",
    defaultValue:
      "Configura ventanas y limites de reserva para ofertas por hora/evento.",
  },
});
...
export default StepCommercialConditions;
